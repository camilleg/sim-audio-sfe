...
# Tidy en.wikipedia.org articles translated into swahili,
# for proofreading and for extracting letter n-grams.
#
# Called by ./a2z.sh.
...
$src = ARGV[0] # e.g., scraped/wikipages-water+supply/swa
$dir = Dir.pwd
Dir.chdir $src
Dir.glob("*.txt").each {|f| 
